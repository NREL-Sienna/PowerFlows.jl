...
function _add_simple_zip_load!(
    sys::System,
    bus::ACBus,
    constant_power_active_power::Number = 0.0,
    constant_power_reactive_power::Number = 0.0,
    constant_current_active_power::Number = 0.0,
    constant_current_reactive_power::Number = 0.0,
    constant_impedance_active_power::Number = 0.0,
    constant_impedance_reactive_power::Number = 0.0,
)
    zip_load = StandardLoad(;
        ...
        bus = bus,
        base_power = 10.0,
        constant_active_power = Float64(constant_power_active_power),
        constant_reactive_power = Float64(constant_power_reactive_power),
        current_active_power = Float64(constant_current_active_power),
        current_reactive_power = Float64(constant_current_reactive_power),
        impedance_active_power = Float64(constant_impedance_active_power),
        impedance_reactive_power = Float64(constant_impedance_reactive_power),
